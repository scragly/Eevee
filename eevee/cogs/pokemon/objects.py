...
class Pokemon():
    ...
    def __init__(self, bot, pkmn, guild=None, **attribs):
        ...
        self.types = self._get_type(self.name)
        self.pb_raid = None
    ...
    def raid_level(self):
        ...
        return (self.bot.raid_pokemon[self.name]["level"]
                if self.is_raid else None)
